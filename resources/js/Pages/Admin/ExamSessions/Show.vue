<template>
    <Head>
        <title>Detail Sesi Ujian - SITEDI</title>
        <link
            rel="shortcut icon"
            type="image/png"
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        <h5>
                            <i class="fa fa-stopwatch"></i> Detail Sesi Ujian
                        </h5>
                        <hr />
                ...
                <div class="card border-0 shadow">
                    <div class="card-body">
                        ...
                        <Link
                            ...
                            type="button"
                        >
                            <i class="fa fa-user-plus"></i> Enrolle Siswa</Link
                        >
                        <div class="table-responsive mt-3">
                            ...
                            >
                                ...
                                <tbody>
                                    <tr
                                        v-for="(data, index) in exam_session
                                            .exam_groups.data"
                                        :key="index"
                                    >
                        ...
                        <Pagination
                            :links="exam_session.exam_groups.links"
                            align="end"
                        />
                    </div>
                </div>
        ...
        const destroy = (exam_session_id, exam_group_id) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Inertia.delete(
                        `/admin/exam_sessions/${exam_session_id}/enrolle/${exam_group_id}/destroy`
                    );
