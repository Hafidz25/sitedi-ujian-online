...
<template>
    ...
    <div class="row gy-3" v-if="exam_groups.length > 0">
                        ...
                        >
                            <thead>
                                <tr>
                                    ...
                                    <td>
                                        {{ data.exam_group.exam.lesson.title }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{
                                            data.exam_group.student.classroom
                                                .title
                                        }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        {{ data.exam_group.exam_session.title }}
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div v-if="data.grade.end_time == null">
                        ...
                        >
                            <div v-if="data.grade.start_time == null">
                                <Link
                                    :href="`/student/exam-confirmation/${data.exam_group.id}`"
                            ...
                            <div v-else>
                                <Link
                                    :href="`/student/exam/${data.exam_group.id}/1`"
                        ...
                        <div v-else>
                            ...
                            >
                                <button
                                    class="btn btn-md btn-gray-700 border-0 shadow w-100 mt-2"
                                    disabled
                                >
                                    Belum Mulai
                                </button>
                            ...
                            >
                                <button
                                    class="btn btn-md btn-danger border-0 shadow w-100 mt-2"
                                    disabled
                                >
                                    Waktu Terlewat
                                </button>
