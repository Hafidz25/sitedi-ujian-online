    ...
    >
        <div class="sidebar-inner px-4 pt-3">
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                        ...
                        <span>
                            <span class="sidebar-icon">
                                <svg
                                    ...
                                    height="18"
                                    fill="currentColor"
                                    class="bi bi-speedometer2 icon icon-xs me-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                ...
                <li
                    class="nav-item"
                    :class="{ active: $page.url.startsWith('/admin/lessons') }"
                >
                    <Link
                        href="/admin/lessons"
                        class="nav-link d-flex justify-content-between"
                        ...
                        <span>
                            <span class="sidebar-icon">
                                <svg
                                    ...
                                    height="18"
                                    fill="currentColor"
                                    class="bi bi-bookmarks icon icon-xs me-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                ...
                <li
                    class="nav-item"
                    :class="{
                        active: $page.url.startsWith('/admin/classrooms'),
                    }"
                >
                    <Link
                        ...
                        <span>
                            <span class="sidebar-icon">
                                <svg
                                    ...
                                    height="18"
                                    fill="currentColor"
                                    class="bi bi-back icon icon-xs me-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                ...
                <li
                    class="nav-item"
                    :class="{ active: $page.url.startsWith('/admin/students') }"
                >
                    <Link
                        href="/admin/students"
                        class="nav-link d-flex justify-content-between"
                        ...
                        <span>
                            <span class="sidebar-icon">
                                <svg
                                    ...
                                    height="18"
                                    fill="currentColor"
                                    class="bi bi-people-fill icon icon-xs me-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                        ...
                        <span>
                            <span class="sidebar-icon">
                                <svg
                                    ...
                                    height="18"
                                    fill="currentColor"
                                    class="bi bi-pencil-square icon icon-xs me-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                ...
                <li
                    class="nav-item"
                    :class="{
                        active: $page.url.startsWith('/admin/exam_sessions'),
                    }"
                >
                    <Link
                        ...
                        <span>
                            <span class="sidebar-icon">
                                <svg
                                    ...
                                    height="18"
                                    fill="currentColor"
                                    class="bi bi-graph-up-arrow icon icon-xs me-2"
                                    viewBox="0 0 16 16"
                                >
                                    <path
                                        fill-rule="evenodd"
